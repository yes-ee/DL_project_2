...
#
# print("PAD Token:", vocab["<PAD>"])  # 출력: 0
# print("SOS Token:", vocab["<SOS>"])  # 출력: 1
# print("EOS Token:", vocab["<EOS>"])  # 출력: 2
#
# print("Validation Question:", x_valid[0])  # 질문 샘플
# print("Validation Answer:", t_valid[0])    # 응답 샘플
